...
for t = trainTStart:trainTEnd
    ...
    trainFN = dir(['D:\home\bxn200003\scratch\test_zone\avg_embryo\trainData\train_time_' num2str(t) '_numCell_*.csv']);
    if size(trainFN,1)>0
        trainFN =['D:\home\bxn200003\scratch\test_zone\avg_embryo\trainData\' trainFN.name];
